import{a as C,r as g,j as o,B as f}from"./index-C_g83nc7.js";import{T as y}from"./ToolContent-CPG3NUPt.js";import{T as v}from"./ToolTextInput-CF8OsBTK.js";import{T}from"./ToolTextResult-h-NChVzd.js";import{s as x}from"./csv-DDPAtGY4.js";import{T as u}from"./TextFieldWithDesc-PPwE1_13.js";import{C as h}from"./CheckboxWithDesc-wy5nrFmd.js";import"./TextField-BB1W8KIt.js";import"./ContentPaste-CjGTXkhv.js";import"./InputFooter-BEiN93nS.js";import"./ResultFooter-BsMB-Y2y.js";import"./FormControlLabel-BYSc6Di4.js";import"./Checkbox-eIAKSjSC.js";import"./SwitchBase-BBer0tk-.js";function b(i,s,e,l,r){const t=s+1;if(!l&&i.length===1&&i[0]==="")return{title:"Missing Line",message:`Line ${t} is empty.`};if(i.length<e)return{title:`Found missing column(s) on line ${t}`,message:`Line ${t} has ${e-i.length} missing column(s).`};if(i.length==e&&r){let c=!1,p=`Empty values on line ${t}: `;if(i.forEach((d,a)=>{d.trim()===""&&(c=!0,p+=`column ${a+1}, `)}),c)return{title:`Found missing values on line ${t}`,message:p.slice(0,-2)+"."}}return null}function L(i,s){if(!i)return"";if(s.messageLimit&&s.messageNumber<=0)throw new Error("Message number must be greater than 0");const e=x(i,!0,s.commentCharacter,s.emptyLines,s.csvSeparator,s.quoteCharacter),l=Math.max(...e.map(t=>t.length)),r=e.map((t,c)=>b(t,c,l,s.emptyLines,s.emptyValues)).filter(Boolean).map(t=>`Title: ${t.title}
