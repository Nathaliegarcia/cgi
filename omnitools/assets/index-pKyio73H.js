import{aE as C,a as g,r as h,j as o,B as u}from"./index-C_g83nc7.js";import{T as x}from"./ToolContent-CPG3NUPt.js";import{T as S}from"./ToolTextInput-CF8OsBTK.js";import{T as k}from"./ToolTextResult-h-NChVzd.js";import{C as f}from"./CheckboxWithDesc-wy5nrFmd.js";import{S as T}from"./SimpleRadio-kuqVngOy.js";import"./TextField-BB1W8KIt.js";import"./ContentPaste-CjGTXkhv.js";import"./InputFooter-BEiN93nS.js";import"./ResultFooter-BsMB-Y2y.js";import"./FormControlLabel-BYSc6Di4.js";import"./Checkbox-eIAKSjSC.js";import"./SwitchBase-BBer0tk-.js";import"./Radio-UAGSoQ3a.js";function z(e,c,t,a,i){if(e[0]=="")return"";if(e.length>3)throw new Error(`Time contains more than 3 parts on line ${c}`);[...e,"0","0"].forEach((s,d)=>{if(!C(s))throw new Error(`Time doesn't contain valid ${["hours","minutes","seconds"][d]} on line ${c}`)});const r=t?e.slice(0,2):e.slice(0,1);return a&&(t?r.push("0"):r.push("0","0")),i?r.map(s=>String(s).padStart(2,"0")).join(":"):r.join(":")}function P(e,c,t,a){const i=[];return e.split(`
