import{aE as m,a as d,r as a,j as l}from"./index-C_g83nc7.js";import{T as h}from"./ToolContent-CPG3NUPt.js";import{T}from"./ToolTextInput-CF8OsBTK.js";import{T as f}from"./ToolTextResult-h-NChVzd.js";import"./TextField-BB1W8KIt.js";import"./ContentPaste-CjGTXkhv.js";import"./InputFooter-BEiN93nS.js";import"./ResultFooter-BsMB-Y2y.js";function c(t,e=0){if(e>=t.length)return 0;const s=[3600,60,1];return Number(t[e])*s[e]+c(t,e+1)}function x(t,e){if(t[0]=="")return"";if(t.length>3)throw new Error(`Time contains more than 3 parts on line ${e}`);return[...t,"0","0"].forEach((o,n)=>{if(!m(o))throw new Error(`Time doesn't contain valid ${["hours","minutes","seconds"][n]} on line ${e}`)}),c(t).toString()}function w(t){const e=[];return t.split(`
