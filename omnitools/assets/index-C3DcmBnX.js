import{r as C,j as e,B as u}from"./index-C_g83nc7.js";import{T as P}from"./ToolContent-CPG3NUPt.js";import{T as b}from"./ToolTextInput-CF8OsBTK.js";import{T as x}from"./ToolTextResult-h-NChVzd.js";import{S as d}from"./SelectWithDesc-FrpNoHFy.js";import{C as y}from"./CheckboxWithDesc-wy5nrFmd.js";import{S as p}from"./SimpleRadio-kuqVngOy.js";import{T as h}from"./TextFieldWithDesc-PPwE1_13.js";import{s as w,g as F}from"./csv-DDPAtGY4.js";import"./TextField-BB1W8KIt.js";import"./ContentPaste-CjGTXkhv.js";import"./InputFooter-BEiN93nS.js";import"./ResultFooter-BsMB-Y2y.js";import"./FormControlLabel-BYSc6Di4.js";import"./Checkbox-eIAKSjSC.js";import"./SwitchBase-BBer0tk-.js";import"./Radio-UAGSoQ3a.js";function k(r,o){const n=o.fromPositionStatus?Number(o.fromPosition):r.findIndex(a=>a===o.fromHeader)+1,l=o.toPositionStatus?Number(o.toPosition):r.findIndex(a=>a===o.toHeader)+1;if(n<=0||l<=0)throw new Error("Invalid column positions. Check headers or positions.");if(n>r.length||l>r.length)throw new Error(`There are only ${r.length} columns`);return[n,l]}function V(r,o,n){if(o<=0||n<=0)throw new Error("Columns position must be greater than zero ");return r.map(l=>{const a=[...l];return[a[o-1],a[n-1]]=[a[n-1],a[o-1]],a})}function j(r,o){if(!r)return"";const n=w(r,o.deleteComment,o.commentCharacter,o.emptyLines),l=Math.max(...n.map(m=>m.length));for(let m=0;m<n.length;m++)for(let c=0;c<l;c++)n[m][c]||(n[m][c]=o.emptyValuesFilling?"":o.customFiller);const a=k(n[0],o);return V(n,a[0],a[1]).join(`
